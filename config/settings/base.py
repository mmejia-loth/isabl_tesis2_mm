...
)  # (isabl_tesis2/config/settings/base.py - 3 = isabl_tesis2/)
APPS_DIR = ROOT_DIR.path("isabl_tesis2")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///isabl_tesis2")}
...
THIRD_PARTY_APPS = [
    # Other third party apps go here
    "django_celery_beat"
]
LOCAL_APPS = [
...
INSTALLED_APPS = DJANGO_APPS + ISABL_REQUIRED_APPS + THIRD_PARTY_APPS + LOCAL_APPS

# MIGRATIONS
# ------------------------------------------------------------------------------
# https://docs.djangoproject.com/en/dev/ref/settings/#migration-modules
MIGRATION_MODULES = {
    "sites": "isabl_tesis2.contrib.sites.migrations"
}
...
LOGIN_REDIRECT_URL = "isabl_api_v1:docs"
...
# DJANGO-CORS
# ------------------------------------------------------------------------------
# https://stackoverflow.com/a/37931084/3949081
...
ADMINS = [("""Daniela Varela""", "dvt@dvt.com")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = ADMINS

# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["isabl_tesis2.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
...
# user isabl_api preferences
REST_AUTH_SERIALIZERS = {
    "USER_DETAILS_SERIALIZER": "isabl_api.serializers.CustomUserDetailsSerializer",
    "PASSWORD_RESET_SERIALIZER": "isabl_api.serializers.PasswordResetSerializer",
}
